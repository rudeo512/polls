...
import com.caru.polls.api.response.ModelMapper;
...
import com.caru.polls.core.choice.ChoiceVoteCount;
import com.caru.polls.core.user.User;
import com.caru.polls.core.user.UserRepository;
import com.caru.polls.core.vote.Vote;
import com.caru.polls.core.vote.VoteRepository;
import com.caru.polls.exception.BadRequestException;
...
public class PollService {
	...
	public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
		...
		return new PagedResponse<>(pollResponses, userVotedPollIds.getNumber(), userVotedPollIds.getSize(), userVotedPollIds.getTotalElements(), userVotedPollIds.getTotalPages(),
